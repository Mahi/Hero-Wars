...
def _view_skills_build(menu: Menu, player: Player):
    if menu.hero_type is None:
        menu.hero_type = player.hero._type_object
    menu.description = menu.hero_type.name
    page = 0
    option_count = 0
    skill_index = 0
    for skill in menu.hero_type.skill_types:
        description = [
